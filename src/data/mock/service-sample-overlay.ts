...
function journeyKMusicPalace(postId: string): RouteJourney {
  ...
  const spots: RouteSpot[] = [
    ...
    spot(postId, 5, {
      ...
      title: "덕수궁 대한문 — 이날치 ‘Feel the Rhythm of Korea’",
      place_name: "덕수궁 대한문",
      spot_name: "덕수궁 대한문",
...
// 아래는 K-MOVIE 테마 예시 1건 — 경복궁/광화문 동선을 영화 관점으로 다시 풀어 씀.
const SAMPLE_DEFINITIONS: SampleDef[] = [
  {
    ...
    summary:
      "「택시운전사」 광장 시위 씬, 「베테랑」 추격 거리, 「관상」 경복궁 담장 — 한 동선에 영화 세 편의 장면을 담아 걷습니다.",
    body:
      "광화문은 한국 영화에서 가장 자주 등장하는 무대 중 하나입니다. 같은 광장이라도 영화별로 비추는 각도와 시간대가 다르고, 그 차이를 알면 산책 자체가 한 편의 영화 회상이 됩니다.\n\n광장 한복판은 「택시운전사」(2017)의 1980년 시위 씬을 다시 떠올리게 합니다. 인파 사이를 빠져나가는 동선과, 차량 진입 차단봉이 비춰진 같은 자리에서 멈춰 잠시 정렬하면 그 장면의 무게가 느껴집니다. 그다음 광화문 광장 동쪽 보행로로 빠지면 「베테랑」(2015)에서 황정민이 달리던 거리와 같은 라인입니다. 「관상」(2013)의 클로즈업이 잡힌 경복궁 담장은 줄 서지 않고도 사진을 남길 수 있는 각도가 따로 있습니다.\n\n관광지로만 걷지 말고, 영화 속 한 장면처럼 걸어보세요 — 같은 길도 더 또렷이 보입니다.",
    tags: ["K-MOVIE", "광화문권", "촬영지", "역사"],
    category_slug: "hot-places",
    kind: "hot_place",
    post_format: "route",
    route_highlights: [
      "광장 시위 씬 — 차단봉 자리에서 잠시 멈춰 시선 정렬 (택시운전사)",
      "동쪽 보행로 추격 라인 — 큰 길 안쪽으로 빠르게 걸어보기 (베테랑)",
      "경복궁 담장 클로즈업 각도 — 대각선 위치에서 사람 적게 잡기 (관상)",
    ],
    hero_subject: "mixed",
    recommended_boost: 5,
  },
  // ── K-DRAMA 테마 (강남 동선을 드라마 시점으로 재해석) ─────────────────────
  {
    ...
    title: "K-DRAMA 강남 — 「이상한 변호사 우영우」와 「응답하라」의 강남 골목",
    summary:
      "테헤란로 오피스 거리, 골목 카페, 야간 네온 — 한국 드라마가 강남을 비추는 세 가지 톤을 한 동선에 묶었습니다.",
    body:
      "강남은 한국 드라마에서 가장 자주 등장하지만, 그 모습은 작품마다 완전히 다릅니다. 「이상한 변호사 우영우」(2022)의 테헤란로 오피스 워크는 직장인 동선이고, 「응답하라 1994」의 강남은 가족 골목이며, 「태양의 후예」 후속작들의 강남은 야간 네온의 도시입니다.\n\n11번 출구에서 시작해 테헤란로 큰 길을 걸으면 「우영우」의 출근 컷이 보입니다. 골목으로 한 칸 들어가면 「응답하라」 톤의 작은 카페가 있고, 다시 큰 길로 나와 저녁에 들어서면 「상속자들」 후속작의 야경 라인입니다. 같은 6시간 안에 세 작품의 시간대를 모두 걸을 수 있습니다.\n\n드라마 한 편을 떠올리며 걸으면, 평범한 출퇴근 거리도 무대처럼 보입니다.",
    tags: ["K-DRAMA", "강남역권", "촬영지", "테헤란로"],
    category_slug: "hot-places",
    kind: "hot_place",
    post_format: "route",
    route_highlights: [
      "11번 출구 → 테헤란로 직선 — 우영우 출근 워크 그대로",
      "큰 길 안쪽 골목 카페 — 응답하라 톤의 좁은 골목",
      "야간 메인 라인 — 상속자들·태양의 후예 후속 야경",
    ],
    hero_subject: "place",
    recommended_boost: 4,
  },
  // ── K-POP 테마 (광화문 단축 동선을 K-POP 뮤직비디오 / 팬투어 관점으로) ────
  {
    ...
    title: "K-POP 광화문 — 뮤직비디오 속 광장, 팬 투어 동선",
    summary:
      "BTS·뉴진스·아이유 MV에 자주 등장한 광화문 광장과 담장 라인을 짧은 50분 루프로 묶은 K-POP 팬 투어 코스입니다.",
    body:
      "광화문은 K-POP 뮤직비디오에서 자주 등장하는 무대입니다. 광장의 넓은 부감 컷, 담장과 기와의 대각선 컷, 광화문 정면의 정렬 컷 — 세 가지 시그니처 앵글이 같은 동선 안에 모두 있습니다.\n\n팬 입장에서는 짧게 50분 안에 'MV에서 본 그 자리'를 모두 찍을 수 있는 게 핵심입니다. 광장 중앙에서 부감을 잡고, 담장 라인은 대각선 위치에서 사람을 덜 잡히게 찍고, 광화문 정면은 정렬 라인을 맞춰 정사진을 한 컷 남기는 흐름입니다.\n\n포토 카드도 가져오면 같은 자리에서 비교 샷을 찍기 좋습니다.",
    tags: ["K-POP", "광화문권", "MV촬영지", "팬투어", "사진"],
    category_slug: "hot-places",
    kind: "hot_place",
    post_format: "route",
    route_highlights: [
      "광장 중앙 부감 — BTS·뉴진스 MV의 그 자리",
      "담장 대각선 컷 — 사람 덜 잡히는 각도 따로 있음",
      "광화문 정면 정렬 — 포토카드 비교 샷 추천",
    ],
    hero_subject: "place",
    recommended_boost: 4,
  },
  ...
  { withRoute: true, journey: journeyGangnamWalk, title: "강남 식사·카페 도보", summary: "배고프면 골목만 짧게—복귀는 테헤란로 큰 길.", body: "지도 핀과 실제 입구 어긋나는 경우 많음—건물 번지까지 확인.", tags: ["강남역권", "식사", "도보"], category_slug: "food", kind: "food", post_format: "route" },
  {
    ...
    title: "서울 궁궐 골목에서 만나는 K-뮤직 씬 — 경복궁에서 덕수궁까지",
    summary: "BTS 〈IDOL〉의 근정전, CL 〈화〉의 소격동, 이날치의 덕수궁 — 조선의 공간이 무대가 된 다섯 장면.",
    body:
      "서울의 오래된 궁궐과 골목은 낮에는 역사 산책길이지만, 카메라가 켜지는 순간 완전히 다른 장면이 됩니다. 전통 건축의 선, 넓은 마당, 낮은 담장, 그리고 그 사이를 걷는 현대적인 음악. 이 하루웨이는 경복궁과 소격동, 정동 일대를 따라가며 K-뮤직 영상 속 서울의 장면들을 다시 짚어봅니다.\n\n걷는 반경은 넓지 않습니다. 경복궁을 중심으로 북촌, 소격동, 광화문, 정동까지 이어지는 도심 골목. 큰 이동보다 좋은 건, 장면과 장면 사이를 직접 걸으며 분위기가 바뀌는 순간을 느낄 수 있다는 점입니다.\n\n첫 자리는 경복궁 근정전. BTS가 미국 NBC 〈더 투나잇 쇼 스타링 지미 팰런〉의 ‘BTS Week’에서 〈IDOL〉 무대를 선보인 곳입니다. 근정전은 경복궁의 중심 건물로, 조선 왕실의 권위와 격식을 상징하는 공간. 넓게 열린 마당과 정면으로 뻗은 축, 반복되는 전각의 선이 퍼포먼스를 더 크게 만듭니다. 음악은 현대적이지만 배경은 가장 한국적인 궁궐 — 화면 속 장면은 단순한 무대가 아니라 ‘서울이 자신을 소개하는 방식’처럼 보입니다.\n\n근정전이 강한 에너지의 무대였다면, 같은 방송에서 BTS가 〈소우주〉를 선보인 경회루는 훨씬 서정적인 장면입니다. 물 위에 떠 있는 듯한 누각은 낮에는 단정하고 해가 기울면 더 깊어집니다. 화려하게 밀어붙이지 않고 공간이 음악의 여백을 만들어주는, 드문 조합.\n\n경복궁에서 북촌 방향으로 걸어가면 소격동입니다. 이 근방의 종친부 경근당과 옥첩당은 씨엘(CL)이 미국 CBS 〈더 레이트 레이트 쇼 위드 제임스 코든〉에서 공개한 〈화(HWA)〉 무대의 배경. 경복궁이 국가적·장엄한 공간이라면 종친부 일대는 조금 더 조용하고 밀도가 있습니다. 낮은 건물, 전통 건축, 미술관, 카페가 가까이 붙어 있어 〈화〉의 강한 리듬과 CL의 존재감이 오히려 더 선명하게 보입니다.\n\nCL의 무대는 종친부에서 끝나지 않고 국립현대미술관 서울관(MMCA)으로 이어집니다. 당시 서울관의 전시 공간과 작품 앞에서 무대가 계속됐고, 전통 공간에서 현대미술 공간으로 넘어가는 흐름 자체가 〈화〉의 콘셉트와 잘 맞습니다. 단순히 ‘여기가 촬영지입니다’가 아니라 전통→현대→골목→미술관으로 이어지는 장면 전환을 그대로 따라가는 구간.\n\n마지막은 정동의 덕수궁 대한문. 한국관광공사의 ‘Feel the Rhythm of Korea’ 서울 편에서 이날치밴드와 앰비규어스 댄스컴퍼니가 보여준 장면의 주요 배경 중 하나입니다. K팝 아이돌 무대와는 결이 다른 — 전통 판소리 기반의 음악, 독특한 춤, 궁궐 앞 도시 풍경이 섞이면서 ‘서울이 이렇게도 보일 수 있구나’라는 인상을 줍니다. 경복궁이 웅장하다면 덕수궁 대한문은 도심과 훨씬 가깝습니다. 차도, 빌딩, 궁궐 담장이 한 화면에 들어옵니다.\n\nBTS의 경복궁, CL의 소격동, 이날치의 덕수궁까지 — 서울의 전통 공간이 K-뮤직의 무대가 된 순간을 따라 걷는 하루. 정확한 스팟 위치·감상 포인트·이동 동선·소요 시간은 하루루트에서 이어보세요.",
    tags: ["K-MUSIC", "K-POP", "경복궁", "덕수궁", "광화문권"],
    category_slug: "hot-places",
    kind: "hot_place",
    post_format: "route",
    route_highlights: [
      "경복궁 근정전 — BTS 〈IDOL〉이 한국을 소개한 자리.",
      "경회루 — 같은 방송의 〈소우주〉가 더 조용히 빛난 장소.",
      "소격동 종친부·MMCA — CL 〈화〉가 전통과 현대를 잇는 골목.",
      "덕수궁 대한문 — 이날치 ‘Feel the Rhythm’의 도심형 궁궐.",
    ],
    hero_subject: "place",
    recommended_boost: 8,
  },
