...
/** K-MUSIC × 궁궐 — 경복궁·소격동·정동 (BTS · CL · 이날치) */
function journeyKMusicPalace(postId: string): RouteJourney {
  const pts: MapLatLng[] = [
    { lat: 37.5786, lng: 126.9770 }, // 근정전
    { lat: 37.5793, lng: 126.9745 }, // 경회루
    { lat: 37.5773, lng: 126.9803 }, // 종친부
    { lat: 37.5786, lng: 126.9803 }, // MMCA 서울관
    { lat: 37.5658, lng: 126.9750 }, // 덕수궁 대한문
  ];
  const spots: RouteSpot[] = [
    spot(postId, 1, {
      lat: 37.5786, lng: 126.9770,
      title: "시작 — 궁궐의 중심에서 K-뮤직 첫 장면",
      place_name: "경복궁 근정전",
      spot_name: "경복궁 근정전",
      display_name: "경복궁 근정전",
      real_place_name: "경복궁 근정전",
      category: "문화재",
      district: "종로구",
      address: "서울특별시 종로구 사직로 161",
      road_address: "사직로 161",
      address_line: "서울 종로구 사직로 161",
      naver_link: "https://map.naver.com/p/search/%EA%B2%BD%EB%B3%B5%EA%B6%81%20%EA%B7%BC%EC%A0%95%EC%A0%84",
      image_query: "경복궁 근정전",
      images: { hero: IMG_GYEONGBOKGWUNG_GATE },
      source_status: "verified",
      short_description: "BTS가 〈더 투나잇 쇼〉 ‘BTS Week’에서 〈IDOL〉을 선보인 궁궐의 중심.",
      body: "근정전 마당의 축, 정면으로 뻗은 단청, 반복되는 전각의 선이 퍼포먼스를 더 크게 만듭니다. 현대 음악이 가장 한국적인 배경 위에 놓일 때 화면이 어떻게 보이는지 — 직접 서 보면 차이가 분명해집니다.",
      image_urls: localPair(postId, "gwanghwamun", 14),
      recommend_reason: "K-팝 무대로 가장 자주 인용되는 한국적 공간. 영상을 본 사람일수록 인상 깊은 첫 스팟.",
      stay_duration_minutes: 35,
      photo_tip: "정면 축 한 컷 + 단청 디테일 한 컷. 두 컷이면 충분합니다.",
      caution: "근정전 내부는 진입 불가. 정해진 동선 안에서만 머무세요.",
      featured: true,
      theme_reason: "K-MUSIC 핵심 무대 — BTS 〈IDOL〉이 한국을 ‘소개한 방식’.",
      what_to_do: "멀리서 한 컷 → 가까이서 한 컷 → 마당 가장자리로 빠져 다음 스팟으로.",
      image_alt: "경복궁 근정전과 마당",
      next_move_minutes: 6,
      next_move_distance_m: 280,
      next_move_mode: "walk",
    }),
    spot(postId, 2, {
      ...
      title: "전환 — 웅장에서 서정으로 넘어가는 감상",
      place_name: "경복궁 경회루",
      spot_name: "경복궁 경회루",
      display_name: "경복궁 경회루",
      real_place_name: "경복궁 경회루",
      category: "문화재",
      district: "종로구",
      address: "서울특별시 종로구 사직로 161",
      road_address: "사직로 161",
      address_line: "경복궁 경회루",
      naver_link: "https://map.naver.com/p/search/%EA%B2%BD%ED%9A%8C%EB%A3%A8",
      image_query: "경복궁 경회루 누각 물",
      images: { hero: IMG_GYEONGBOKGWUNG_WALL },
      source_status: "verified",
      leg_from_previous: "근정전에서 서북쪽 방향. 안내판 ‘경회루’ 화살표를 따라 5~7분.",
      short_description: "물 위 누각의 정적 — 같은 BTS Week에서 〈소우주〉가 차분히 빛난 자리.",
      body: "근정전이 강한 무대였다면 경회루는 여백의 무대입니다. 누각·물·하늘이 함께 들어오는 순간을 만들기 위해 약간 비낀 각도가 필요합니다. 음악과 공간이 서로를 밀어내지 않고 받쳐주는 드문 조합.",
      image_urls: localPair(postId, "gwanghwamun", 35),
      recommend_reason: "근정전 다음의 호흡 조절 — 분위기 전환을 카메라로 체감할 수 있는 자리.",
      stay_duration_minutes: 30,
      photo_tip: "정면보다 30도 비낀 각도. 인물보다 공간의 여백을 우선하세요.",
      caution: "물가 난간 너머는 출입 금지. 사진 한 컷 위해 넘지 마세요.",
      theme_reason: "K-MUSIC 여백의 무대 — 〈소우주〉가 잘 어울리는 이유.",
      what_to_do: "비낀 각도에서 한 컷 → 누각 측면 산책 → 북문 방향으로 빠지기.",
      image_alt: "경복궁 경회루와 연못",
    ...
    spot(postId, 3, {
      ...
      title: "골목 — 전통과 현대 음악이 만나는 구간",
      place_name: "종친부 경근당·옥첩당",
      spot_name: "종친부",
      display_name: "소격동 종친부",
      real_place_name: "종친부 경근당·옥첩당 (소격동)",
      category: "문화재",
      district: "종로구",
      address: "서울특별시 종로구 삼청로 30",
      road_address: "삼청로 30",
      address_line: "서울 종로구 삼청로 30",
      naver_link: "https://map.naver.com/p/search/%EC%A2%85%EC%B9%9C%EB%B6%80",
      image_query: "종친부 경근당 옥첩당 소격동",
      images: { hero: IMG_GYEONGBOKGWUNG_WALL },
      source_status: "verified",
      leg_from_previous: "경복궁 동문(건춘문) → 횡단 → 소격동 골목으로 진입. 8~12분.",
      short_description: "CL이 미국 〈제임스 코든 쇼〉에서 〈화(HWA)〉를 선보인 전통×현대 접점.",
      body: "경복궁이 국가적 장엄함이라면, 종친부 일대는 더 조용하고 밀도가 있습니다. 낮은 전통 건축에 미술관·카페·골목이 붙어 있어, CL의 강한 리듬과 존재감이 오히려 더 또렷이 보입니다. ‘한 점’보다 ‘무드’로 머무세요.",
      image_urls: localPair(postId, "gwanghwamun", 56),
      recommend_reason: "촬영지 단일 포인트가 아니라 ‘동네의 결’을 느껴야 진짜 보이는 자리.",
      stay_duration_minutes: 25,
      photo_tip: "건물 정면보다 처마와 골목이 함께 들어오는 측면 구도.",
      caution: "주변 카페·갤러리는 영업 일정이 변경되는 경우가 있습니다.",
      theme_reason: "K-MUSIC × 전통-현대 — CL의 톤이 가장 잘 살아나는 곳.",
      what_to_do: "건물 정면 한 컷 → 골목 안으로 50m 산책 → 다음 스팟(MMCA)으로 이동.",
      image_alt: "소격동 종친부 경근당과 옥첩당",
      next_move_minutes: 3,
    ...
    spot(postId, 4, {
      ...
      title: "휴식 — 미술관·카페 가까운 호흡 구간",
      place_name: "국립현대미술관 서울관 (MMCA)",
      spot_name: "MMCA 서울관",
      display_name: "국립현대미술관 서울관",
      real_place_name: "국립현대미술관 서울관",
      category: "미술관",
      district: "종로구",
      address: "서울특별시 종로구 삼청로 30",
      road_address: "삼청로 30",
      address_line: "서울 종로구 삼청로 30",
      naver_link: "https://map.naver.com/p/search/%EA%B5%AD%EB%A6%BD%ED%98%84%EB%8C%80%EB%AF%B8%EC%88%A0%EA%B4%80",
      image_query: "국립현대미술관 서울관 외관",
      images: { hero: IMG_GWANGHWAMUN_SQUARE },
      source_status: "verified",
      leg_from_previous: "종친부에서 바로 옆 — 3분 내 도착. 미술관 외부 광장으로 진입.",
      short_description: "CL의 무대가 전통(종친부)에서 현대미술관으로 이어진 자리.",
      body: "전시 공간과 작품 앞으로 무대가 옮겨졌습니다. 종친부에서 MMCA로 넘어오는 ‘공간 전환’ 자체가 〈화〉의 콘셉트와 정확히 겹칩니다. 미술관은 내부보다 외부 동선 — 경복궁·북촌·삼청동을 잇는 허브로서의 위치가 핵심입니다.",
      image_urls: localPair(postId, "gwanghwamun", 77),
      recommend_reason: "전통→현대 전환을 같은 발걸음으로 따라가게 해주는 유일한 스팟.",
      stay_duration_minutes: 30,
      photo_tip: "외부 광장에서 미술관 매스 + 종친부 처마를 한 프레임에. 두 시대가 같이 잡힙니다.",
      caution: "전시 입장료는 별도. 외부 동선만 본다면 무료입니다.",
      theme_reason: "K-MUSIC × 미술관 — CL이 ‘공간을 갈아입는’ 순간.",
      what_to_do: "외부 광장 한 바퀴 → 종친부와 미술관이 같이 들어오는 컷 → 광화문 방향 남쪽으로 이동.",
      image_alt: "국립현대미술관 서울관 외관",
    ...
    spot(postId, 5, {
      ...
      title: "종착 — 궁궐과 도심이 한 화면에 겹치는 마지막 장면",
      place_name: "덕수궁 대한문",
      spot_name: "덕수궁 대한문",
      display_name: "덕수궁 대한문",
      real_place_name: "덕수궁 대한문",
      category: "문화재",
      district: "중구",
      address: "서울특별시 중구 세종대로 99",
      road_address: "세종대로 99",
      address_line: "서울 중구 세종대로 99",
      naver_link: "https://map.naver.com/p/search/%EB%8D%95%EC%88%98%EA%B6%81%20%EB%8C%80%ED%95%9C%EB%AC%B8",
      image_query: "덕수궁 대한문 정문 시청 도심",
      images: { hero: IMG_GYEONGBOKGWUNG_GATE },
      source_status: "verified",
      leg_from_previous: "MMCA → 광화문 → 정동 방향 남하. 도보 25분 또는 지하철 5호선 1정거장.",
      short_description: "이날치 × 앰비규어스 댄스컴퍼니가 보여준 ‘힙조선’ 서울의 입구.",
      body: "K-팝 아이돌 무대와는 결이 다릅니다. 전통 판소리, 독특한 춤, 궁궐 담장 앞 도심 풍경이 한 프레임에 섞이면서 ‘서울은 이렇게도 보일 수 있구나’라는 인상을 만듭니다. 차도·빌딩·궁궐 담장이 동시에 들어오는, 도심형 궁궐의 정수.",
      image_urls: localPair(postId, "gwanghwamun", 98),
      recommend_reason: "코스 마무리에 ‘서울 = 전통+도심’ 메시지를 가장 명확히 보여주는 자리.",
      stay_duration_minutes: 30,
      photo_tip: "대한문 정면 한 컷 + 뒤를 돌아 시청·빌딩이 들어오는 컷. 두 컷의 대비가 핵심.",
      caution: "교대식 시간대(11:00·14:00·15:30 등)는 인파 많음. 일정은 당일 공지 우선.",
      featured: true,
...
function mergeSampleBody(def: SampleDef, route_journey: RouteJourney | undefined, authorName: string): string {
  if (def.withRoute && route_journey) {
    const isGangnam = def.tags.some((x) => x.includes("강남"));
    const beforeYouGo = isGangnam
      ? "카페 노노트북·노키즈는 문 앞에서 먼저 확인하세요. 들어가서 알면 민망합니다. 충전이 필요하면 자리 잡기 전에 카운터에 물어보세요. 퇴근 시간엔 인도가 확 좁아집니다. 큰 길 안쪽으로 붙어 걷세요."
      : "화장실은 지하철 또는 궁 입구에서 먼저 해결하세요. 궁 안 들어가면 다시 나오기 번거롭습니다. 행사 날 펜스는 표지 먼저 보세요. 지도보다 현장 표지가 맞습니다. 길 한가운데서 사진 찍으면 뒤에서 밀려옵니다. 건물 홈 쪽으로 빠지세요.";
    const closing = isGangnam
      ? "퇴근길 도심 오피스 분위기입니다. 유리 빌딩·카페 조명·킥보드가 한꺼번에 움직입니다."
      : "비 오거나 줄 길면 테이크아웃이나 담장만 걸어도 됩니다. 억지로 다 채우면 지칩니다.";
...
function buildSampleStructured(
  ...
  if (def.withRoute && route_journey) {
    ...
    const isGangnam = def.tags.some((x) => x.includes("강남"));
    const orientationTip = isGangnam
      ? "11번 출구 먼저 찾으세요. 테헤란로 방향만 정하면 길 잃기 어렵습니다."
      : "광화문 쪽 출구 먼저 찾으세요. 이곳에서 방향 잡으면 안 헤맵니다.";
    const routeNotes = isGangnam
      ? "카페 노노트북·노키즈는 문 앞에서 먼저 확인하세요. 들어가서 알면 민망합니다. 충전이 필요하면 자리 잡기 전에 카운터에 물어보세요."
      : "화장실은 지하철 또는 궁 입구에서 해결하세요. 궁 안 들어가면 다시 나오기 번거롭습니다. 물은 편의점에서 미리 사두는 게 낫습니다.";
    const closingText = isGangnam
      ? "퇴근길 도심 오피스 분위기입니다. 유리 빌딩·카페 조명·킥보드가 한꺼번에 움직입니다."
      : "도깨비·서울의봄 같은 서울 중심부 느낌입니다. 광장 + 궁 + 도심이 한 번에 겹칩니다.\n\n궁 입장 전 화장실을 이용하세요. 궁궐 내에는 화장실이 없습니다.";
    return {
...
// ── K-MOVIE 테마 시드 (경복궁 + 주변 촬영지 묶음) ──────────────────────────────
// 비즈니스 메모(2026-05): 하루웨이는 같은 동선을 여러 테마로 재해석할 수 있는 콘텐츠 자산.
// "경복궁" 한 스팟이 '역사 산책' 테마와 'K-MOVIE 촬영지' 테마 양쪽에 속할 수 있고,
// 각 테마는 다른 본문·태그·주변 스팟 큐레이션으로 묶일 수 있음.
//
// 본문 작성 규칙: AI_CONTENT_HARUWAY_RULES.md 참조 — 무료 포스트 본문에는 정확한 스팟명·동선·
// 거리·소요시간을 노출하지 않는다. 아티스트·작품·분위기 묘사 중심으로 쓰고, 마지막에 하루루트로 연결한다.
const SAMPLE_DEFINITIONS: SampleDef[] = [
  {
    withRoute: true,
    journey: journeyGwanghwamunClassic,
    title: "K-MOVIE 광화문 — 영화 속 그 장면, 그대로 걷기",
    summary:
      "「택시운전사」의 무게, 「베테랑」의 속도, 「관상」의 정적 — 서울 도심의 같은 공간이 영화마다 다른 얼굴로 보였습니다.",
    body:
      "서울의 한 광장은, 영화가 켜질 때마다 다른 시대를 입습니다. 같은 자리에 카메라가 놓이지만, 비추는 각도와 시간대가 다르면 완전히 다른 장면이 됩니다.\n\n「택시운전사」(2017)는 1980년의 무게를 광장의 한복판에 다시 놓았습니다. 인파가 흐르던 자리, 멈춰서야 했던 자리, 그 공기를 다시 떠올리며 같은 공간을 천천히 걸으면 영화가 비추던 시선의 무게가 발걸음에 얹힙니다. 반면 「베테랑」(2015)은 같은 동네를 속도로 보여줍니다. 큰 길과 보행로 사이의 좁은 라인, 인물이 달려나가는 동선이 도시의 다른 결을 드러냅니다.\n\n「관상」(2013)에 이르면 톤이 다시 바뀝니다. 낮은 담장과 기와의 선이 길게 이어지는 구간에서 카메라가 멈춰 서고, 인물의 옆얼굴과 함께 한국의 오래된 표정이 화면 안에 자리잡습니다. 같은 도심이지만 시간대와 빛의 결을 바꾸면 한 편의 시대극으로도 충분히 보이는 곳입니다.\n\n관광지로 한 번에 훑는 산책과, 영화 속 장면을 따라 걷는 산책은 다른 일입니다. 같은 길도 어떤 작품을 떠올리며 걷느냐에 따라 한층 또렷이 보입니다.\n\n어떤 자리에서 어떤 장면을 떠올리면 좋은지, 빛과 동선은 어떻게 잡으면 좋은지는 하루루트에서 이어집니다.",
    tags: ["K-MOVIE", "광화문권", "촬영지", "역사"],
    category_slug: "hot-places",
    kind: "hot_place",
    post_format: "route",
    route_highlights: [
      "광장의 무게 — 「택시운전사」의 시대를 다시 읽는 첫 구간",
      "도시의 속도 — 「베테랑」이 그린 도심 추격의 결",
      "담장의 정적 — 「관상」이 비춘 한국의 오래된 표정",
    ],
    hero_subject: "mixed",
    recommended_boost: 5,
  },
  ...
  {
    withRoute: true,
    journey: journeyGangnamWalk,
    title: "K-DRAMA 강남 — 출퇴근의 거리, 골목의 카페, 야경의 도시",
    summary:
      "「이상한 변호사 우영우」의 출근길, 「응답하라」의 낮은 골목, 「상속자들」의 야경 — 한 동네가 작품마다 완전히 다른 시간을 입었습니다.",
    body:
      "서울의 한 도심권은, 한국 드라마에서 가장 자주 등장하지만 그 모습은 작품마다 다릅니다. 같은 거리도 어떤 인물이 걷느냐에 따라 출퇴근의 풍경이 되었다가, 가족의 골목이 되었다가, 밤의 무대가 됩니다.\n\n「이상한 변호사 우영우」(2022)는 이 거리를 직장인의 시선으로 비췄습니다. 큰 길의 폭, 보행로의 속도, 유리 빌딩이 만드는 빛의 결 — 평범한 출근길이 한 인물의 일상이 되는 순간입니다. 「응답하라 1994」 시리즈는 같은 동네를 한 칸 안쪽 골목에서 다시 봅니다. 큰 길에서는 보이지 않는 낮은 카페와 좁은 골목, 거기에서 만들어지던 한 시대의 가족 분위기.\n\n저녁이 되면 톤이 또 한 번 바뀝니다. 「상속자들」 후속작들의 야경 라인은 같은 거리를 네온과 글라스의 도시로 재구성합니다. 같은 6시간 안에 한 거리에서 세 시대의 톤을 모두 걸을 수 있다는 점이 이 지역의 매력입니다.\n\n드라마 한 편을 떠올리며 걸을 때, 평범한 출퇴근 거리도 무대처럼 보입니다. 어떤 시간대에 어떤 작품을 떠올리면 좋은지, 어디에서 잠시 쉬어가면 그 톤이 살아나는지는 하루루트에서 이어집니다.",
    tags: ["K-DRAMA", "강남역권", "촬영지", "테헤란로"],
    category_slug: "hot-places",
    kind: "hot_place",
    post_format: "route",
    route_highlights: [
      "출퇴근의 결 — 「우영우」가 비춘 큰 길 워크",
      "골목의 시간 — 「응답하라」가 머물던 낮은 동네",
      "야경의 도시 — 「상속자들」 후속작의 네온 라인",
    ],
    hero_subject: "place",
    recommended_boost: 4,
  },
  ...
  {
    withRoute: true,
    journey: journeyGwangShort,
    title: "K-POP 광화문 — 뮤직비디오 속 한 장면을 다시 걷는 짧은 하루",
    summary:
      "BTS·뉴진스·아이유의 뮤직비디오가 같은 도심권의 다른 결을 보여줍니다. 영상 속 그 분위기를 짧게 다시 걷는 팬 투어 테마.",
    body:
      "서울 도심의 한 광장과 그 주변은, K-POP 뮤직비디오에서 가장 자주 등장하는 무대 중 하나입니다. 카메라가 켜질 때마다 다른 톤이 살아납니다.\n\nBTS의 영상에서 이 지역은 넓은 부감 위로 펼쳐지는 무대로 보였습니다. 광장이 만들어내는 면, 담장과 기와가 만드는 선, 정문이 만드는 정렬 — 세 가지 시각적 요소가 한 동선 안에 모두 들어옵니다. 곡의 인트로가 들리면 자연스럽게 떠오르는 장면들이 같은 지역 안에서 차례로 연결됩니다.\n\n뉴진스의 가벼운 톤은 같은 공간을 또 다른 방식으로 보여줍니다. 큰 마당의 여백 위에 새로운 세대의 색이 얹히면서, 오래된 배경과 가장 최근의 음악이 어색하지 않게 어우러집니다. 아이유의 발라드는 다시 같은 광장을 조용히 비춥니다. 빈자리와 빛, 그 사이의 한 인물.\n\n포토 카드 하나를 손에 쥐고 걷는 것만으로도 영상의 한 장면이 발 아래에서 다시 재생됩니다. 어디에서 어떤 곡을 떠올리면 좋은지, 어느 위치에서 영상 속 컷이 살아나는지는 하루루트에서 이어집니다.",
    tags: ["K-POP", "광화문권", "MV촬영지", "팬투어", "사진"],
    category_slug: "hot-places",
    kind: "hot_place",
    post_format: "route",
    route_highlights: [
      "광장의 면 — BTS 영상이 그렸던 넓은 부감의 결",
      "기와의 선 — 뉴진스 톤이 살아나는 가벼운 무드",
      "정렬의 한 컷 — 아이유의 발라드가 어울리는 정적",
    ],
    hero_subject: "place",
    recommended_boost: 4,
  },
  ...
  { withRoute: true, journey: journeyGwangShort, title: "랜드마크 도보 — 광화문 삼각 루프 50분", summary: "교보빌딩→광장→담장만. 입장 안 해도 기와선 사진 가능.", body: "시간 없으면 스팟마다 사진 욕심 줄이고 방향·그늘만 챙기면 50분 안에 돕니다.", tags: ["광화문권", "사진", "짧은코스"], category_slug: "hot-places", kind: "hot_place", post_format: "route", route_highlights: ["광장 중앙에서 멈추지 마세요. 옆 보행로로 빠지면 훨씬 덜 막힙니다.", "담장길 자전거 도로와 보행로가 겹칩니다. 벨 울리면 붙으세요.", "행사 날 펜스는 표지 먼저 보세요."] },
  { withRoute: true, journey: journeyGangnamWalk, title: "혼자 도보 — 강남역에서 테헤란로까지", summary: "혼행은 큰 길만 기억하면 됨. 창가는 햇빛·웨이팅 체크.", body: "밤에도 가로등 있는 메인으로만 다니면 방향 헷갈림 적음.\n카페 창가는 오후 서향이면 뜨거울 수 있음—겉옷·짧게 앉기.", tags: ["강남역권", "솔로", "K-무드", "야간"], category_slug: "local-tips", kind: "local_tip", post_format: "route", route_highlights: ["퇴근 시간엔 인도가 확 좁아집니다. 큰 길 안쪽으로 붙어 걷세요.", "골목 들어가기 전 지도 한 번만 확인하세요.", "야간엔 이어폰 볼륨을 줄이세요."] },
  { withRoute: true, journey: journeyGwanghwamunClassic, title: "사진 위주 광화문 루트", summary: "동상=기준점, 광장=넓이, 광화문=줄·각도. 삼각대는 통행 안 되는 곳만.", body: "인물은 배경 단순할 때만. 풍경은 대각선 담장이 사람 덜 붙음.", tags: ["광화문권", "사진", "풍경"], category_slug: "local-tips", kind: "local_tip", post_format: "hybrid", route_highlights: ["광장 중앙에서 멈추지 마세요. 옆 보행로로 빠지면 훨씬 덜 막힙니다.", "동상 앞은 ‘궁이 보이는 쪽 발치’로 설명하세요.", "입장 줄이 길면 담장만 걸어도 됩니다."] },
  ...
  {
    withRoute: true,
    journey: journeyKMusicPalace,
    title: "서울 도심에서 만나는 K-뮤직 씬 — 영상 속 그 분위기를 직접 걷는 하루",
    summary: "BTS·CL·이날치가 카메라를 켰던 서울 도심. 장면이 왜 거기서 만들어졌는지를 따라가는 테마 하루.",
    body:
      "서울의 오래된 궁궐과 골목은 낮에는 역사 산책길이지만, 카메라가 켜지는 순간 완전히 다른 장면이 됩니다. 전통 건축의 선, 넓은 마당, 낮은 담장, 그리고 그 사이를 가로지르는 현대적인 음악. 이 하루웨이는 서울 도심 안에서 K-뮤직 영상 속 장면들이 어떻게 만들어졌는지를 따라가 보는 테마 포스트입니다.\n\n이 코스의 매력은 거창한 이동이 아닙니다. 서울 중심부의 10km 안쪽, 오래된 궁궐과 미술관, 골목과 도심이 이어지는 구간 안에서 분위기가 계속 바뀝니다. 한쪽에서는 왕실의 격식이 느껴지고, 다른 쪽에서는 현대미술과 카페 골목의 밀도가 살아납니다. 같은 서울이지만, 카메라가 어느 방향을 향하느냐에 따라 완전히 다른 무대가 됩니다.\n\n이 지역은 특히 K-뮤직 영상과 잘 어울립니다. BTS는 해외 방송 무대에서 한국적인 궁궐 공간을 배경으로 〈IDOL〉과 〈소우주〉를 선보였습니다. 강한 퍼포먼스가 필요한 곡에서는 넓게 열린 마당과 전각의 반복적인 선이 힘을 만들고, 서정적인 곡에서는 물과 누각, 낮은 조명이 음악의 여백을 살려줍니다. 음악은 현대적이지만, 화면 안의 배경은 서울이 가진 가장 오래된 얼굴입니다.\n\n씨엘(CL)의 〈화(HWA)〉 역시 이 지역의 또 다른 분위기를 잘 보여줍니다. 장엄한 궁궐의 스케일과는 달리, 낮은 건축과 조용한 골목, 현대미술 공간이 가까이 붙어 있는 구간에서 강한 리듬과 존재감이 더 선명하게 드러납니다. 전통적인 공간에서 현대적인 공간으로 넘어가는 흐름은 곡의 에너지와도 잘 맞아, 단순한 촬영지가 아니라 하나의 장면 전환처럼 느껴집니다.\n\n또 다른 결의 장면도 있습니다. 이날치밴드와 앰비규어스 댄스컴퍼니가 보여준 ‘Feel the Rhythm of Korea’ 서울 편은 K팝 아이돌 무대와는 다른 방식으로 서울을 보여줍니다. 전통 판소리 기반의 음악, 독특한 춤, 궁궐 앞 도심 풍경이 섞이면서 ‘서울이 이렇게도 보일 수 있구나’라는 인상을 남깁니다. 오래된 담장과 차도, 빌딩과 궁궐이 한 화면 안에 들어오는 장면은 이 지역만의 강한 대비입니다.\n\n이 하루웨이는 단순한 촬영지 인증 코스가 아닙니다. BTS의 무대가 왜 그 공간에서 더 크게 보였는지, CL의 영상이 왜 골목과 현대미술 공간에서 더 선명해졌는지, 이날치의 장면이 왜 서울의 리듬처럼 느껴졌는지를 직접 따라가며 확인하는 테마입니다.\n\n정확한 스팟은 공개하지 않습니다. 어떤 순서로 걸어야 장면의 흐름이 살아나는지, 어느 위치에서 영상을 떠올리면 좋은지, 어디에서 쉬고 어디에서 사진을 남기면 좋은지는 하루루트에서 이어집니다.\n\nK-뮤직 영상 속 서울을 실제 동선으로 따라가고 싶다면, 아래 하루루트에서 전체 코스를 확인해보세요.",
    tags: ["K-MUSIC", "K-POP", "도심", "테마", "광화문권"],
    category_slug: "hot-places",
    kind: "hot_place",
    post_format: "route",
    route_highlights: [
      "시작 — 궁궐의 중심에서 K-뮤직 무대의 첫 장면을 떠올리는 구간.",
      "전환 — 웅장한 공간에서 서정적인 분위기로 넘어가는 감상 구간.",
      "골목 — 전통 건축과 낮은 골목이 현대적인 음악과 만나는 구간.",
      "휴식 — 미술관과 카페가 가까운 지역에서 잠시 쉬어가는 구간.",
      "종착 — 궁궐과 도심이 한 화면에 겹치는 서울의 마지막 장면.",
    ],
    hero_subject: "place",
    recommended_boost: 8,
  },
