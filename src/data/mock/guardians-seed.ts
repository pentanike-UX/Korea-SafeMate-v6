...
export const GUARDIAN_SEED_ROWS: readonly GuardianSeedRow[] = [
  ...
  },
  {
    ...
    display_name: "박도윤",
    headline: "광화문·종로 · 역사 산책",
    bio: "광화문 광장에서 경복궁까지, 도보로 둘러보는 서울 중심부 코스를 안내합니다. 화장실·대기 줄·사진 포인트까지 사전에 짚어 드립니다.",
  ...
  },
  {
    ...
    display_name: "임태윤",
    headline: "신촌에서 가볍게 놀기 좋은 하루를 만드는 하루이",
  ...
  },
  {
    ...
    display_name: "이예준",
    headline: "짐이 많든 가볍든, 용산에서 헤매지 않게 해주는 하루이",
  ...
  },
  {
    ...
    display_name: "김서호",
    headline: "북촌 골목과 사진 스팟을 가장 잘 아는 하루이",
  ...
  },
  {
    ...
    display_name: "김시우",
    headline: "혼자 여행해도 편하게 움직일 수 있게 도와주는 하루이",
